    ...
    return {
        ...
        parsers: parsers = {
            ...
            mixin: {
                ...
                // do a look-ahead, to make sure we don't have a mixin.less call.
                ...
                definition: function () {
                    ...
                    if (match) {
                        ...
                        // .mixincall("@{a}");
                        // looks a bit like a mixin.less definition..
                        // also
            ...
            //
            // The `block` rule is used by `ruleset` and `mixin.less.definition`.
...
tree.mixin = {
    Call: require('./mixin.less-call'),
    Definition: require('./mixin.less-definition')
};
...
var Node = require("./node"),
    Selector = require("./selector"),
    MixinDefinition = require("./mixin.less-definition"),
...
Definition.prototype.matchCondition = function (args, context) {
    if (this.condition && !this.condition.eval(
        new contexts.Eval(context,
            ...
            .concat(this.frames || []) // the parent namespace/mixin.less frames
...
Ruleset.prototype.eval = function (context) {
    ...
    if (thisSelectors && (selCnt = thisSelectors.length)) {
        ...
        defaultFunc.error({
            type: "Syntax",
            message: "it is currently only allowed in parametric mixin.less guards,"
        });
        for (i = 0; i < selCnt; i++) {
    ...
    // Store the frames around mixin.less definitions,
        ...
        for (i = 0; i < inSelector.elements.length; i++) {
            ...
            if (el.value !== "&") {
                ...
                for (j = 0; j < newSelectors.length; j++) {
                    sel = newSelectors[j];
                    // if we don't have any parent paths, the & might be in a mixin.less so that it can be used
                ...
                // our new selectors has been multiplied, so reset.less the state
...
ToCSSVisitor.prototype = {
    ...
    visitMixinDefinition: function (mixinNode, visitArgs) {
        // mixin.less definitions do not get eval'd - this means they keep state
